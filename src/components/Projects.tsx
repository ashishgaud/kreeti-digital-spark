  ...
  const videos = [
    {
      ...
      thumbnailUrl: 'https://via.placeholder.com/640x360/2C74B3/FFFFFF?text=Coohom+Video+1',
    ...
    },
    {
      ...
      thumbnailUrl: 'https://via.placeholder.com/640x360/0A2647/FFFFFF?text=Coohom+Video+2',
  ...
  const socialContentVideos = [
    {
      ...
      thumbnailUrl: 'https://via.placeholder.com/640x360/144272/FFFFFF?text=Social+Video+1',
      videoUrl: 'https://dfcevziyiolgitizwhmn.supabase.co/storage/v1/object/public/media//75d1d80a-b3e8-4b87-b02f-13a5a821a533.mov'
    },
    {
      id: 2,
      title: 'Social Video 2',
      thumbnailUrl: 'https://via.placeholder.com/640x360/0A2647/FFFFFF?text=Social+Video+2',
      videoUrl: 'https://dfcevziyiolgitizwhmn.supabase.co/storage/v1/object/public/media//7467622a-3c60-426d-9622-51cb2da54d53.mov'
    },
    {
      id: 3,
      title: 'Social Video 3',
      thumbnailUrl: 'https://via.placeholder.com/640x360/144272/FFFFFF?text=Social+Video+3',
    ...
    },
    {
      ...
      thumbnailUrl: 'https://via.placeholder.com/640x360/2C74B3/FFFFFF?text=Social+Video+4',
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full mb-8 grid grid-cols-3 h-auto">
            <TabsTrigger value="coohom" className="py-3">
              <Film className="mr-2 h-4 w-4" /> Coohom
            </TabsTrigger>
            <TabsTrigger value="canva" className="py-3">
              <Image className="mr-2 h-4 w-4" /> Canva
            </TabsTrigger>
            <TabsTrigger value="social" className="py-3">
              <Instagram className="mr-2 h-4 w-4" /> Social Content
            </TabsTrigger>
          </TabsList>
